                ...
                <div className='px-5'> 
                    ...
                    <div className='w-full'>
                        <div className='flex space-x-4'>
							<div className='flex-1 mr-2 text-lg text-white font-medium'>1. Title</div>
						</div>
						...
						<div className='text-white text-sm'>
							<p className="mt-3">
                                Given an array of integers <code>nums</code> and a integers
                                <em>indices of the two numbers such that they add up to</em>
                                <code>target</code>
                            </p>
                            <p className="mt-3">
                                You may assume that each input would have <strong>exactly on solution,</strong> 
						...
						<div className='mt-4'>
                            ...
                            <div>
                                ...
                                <pre>
									<strong className='text-white'>Input: </strong> nums = [2,7,
                                    11,15]
                                     target = 9{" "}
									<br />
